  ...
  return (
    <div className={styles.content_div}>
        ...
        <div className={styles.filmDesc_div}>
          ...
          <div>
            ...
            <div className={styles.epilep}>
              ...
              <Checkbox
                ...
                icon={
                  <SvgIcon viewBox="0 0 1280 1280">
                    ...
                    />
                    <path
                      d="M216.4 378.5c-2.6 0-5 .2-6.9.5-40.9 6.5-71.7 39.5-85.6 91.9-7.9 30.1-9 71.6-2.8 108.1 14.3 85 63.5 163.1 121.7 193.3 29.8 15.4 59.5 18.1 85 7.5 37.6-15.6 62.3-56 70.4-115.3 1.6-11.9 1.6-47.2-.1-61-13-110.2-80.9-206.9-156.4-223-6.7-1.4-17.2-2.2-25.3-2z"
                      style={{
                        strokeWidth: 10,
                        strokeDasharray: "none",
                        painOrder: "fill markers stroke",
                        stroke: "#fff",
                        strokeOpacity: 1,
                        fill: "none",
                      }}
                    />
                    <path
                      d="M854.6 52.6c-31.1 6.1-63.6 29.9-90.5 66.1-34.6 46.5-58 108-66.8 175.8-2.8 21.6-2.5 69.8.5 89.4 7 44.7 21.9 78.9 44.2 101.1a80.9 80.9 0 0 0 67.5 25.2c58.1-7.2 115.4-70.6 146-161.6 25.4-75.5 28.1-155 7.3-215.6-20.3-59.1-61.5-89.7-108.2-80.4ZM461.5 32.4a85.2 85.2 0 0 0-43.6 25.5A141.1 141.1 0 0 0 390 97c-47.7 95.4-31.6 252.8 35.3 343a210.6 210.6 0 0 0 35.7 36.6c35.4 26.7 75.2 28.1 107.1 3.8 32.7-25 55.1-73.2 63.6-136.9 2.1-16.4 2.5-67.2.5-84-8.2-70.2-29.1-128.3-61.8-172.2a223.7 223.7 0 0 0-34.4-35 139.5 139.5 0 0 0-36.5-18.8c-8.3-2.3-30.2-2.9-38-1.1z"
                      style={{
                        fill: "none",
                        stroke: "#fff",
                        strokeOpacity: 1,
              ...
              <h5 className={styles.h5_test}>Убрать эпилептические сцены</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="description_div">
        <h2>Описание</h2>
        <p>
          Столкнувшись с неразрешимыми проблемами, пять молодых москвичей
          убегают в монастырь неподалеку от полузаброшенной деревни Топи. Они
          воспринимают поездку как приключение, долгожданную свободу от забот и
          возможность забыться. Однако путешествие оборачивается чередой
          загадочных событий, которые лишь приближают то, от чего они бежали, и
          заставляют сомневаться в реальности происходящего.
        </p>
      </div>

      <div>
        {/* <div className={styles.topi_bg}></div>
        <img className={styles.topi} src="./topi.webp"></img> */}
      </div>
    </div>
  );
}
